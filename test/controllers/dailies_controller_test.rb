...
class DailiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create daily" do
    assert_difference('Daily.count') do
      post dailies_url, params: { daily: { content: @daily.content, localName: @daily.localName, name: @daily.name } }
    end
  ...
  test "should update daily" do
    patch daily_url(@daily), params: { daily: { content: @daily.content, localName: @daily.localName, name: @daily.name } }
